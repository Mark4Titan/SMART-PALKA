...
if (anWrite > 0 && ST > 1.3) {
  ...
  //if (power_supply == 0){Lx_f=1;Lx = 60;} 
  //if (G0 && power_supply) {Lx_f=1;Lx = 255;}  
  //if (E0 && power_supply) {Lx_f=1;Lx = 20;} 
...
void setColor(){  
  ...
  if (millis() - deboB >= 300 && power_supply == 0 && charge_end == 1 && CHARGING_MODE) {
    deboB = millis();
    CAE=1;
     R1=0;
     R2=0;
 ...
 if (millis() - deboA >= 300 && E0 && discharge < 6){
    deboA = millis(); 
