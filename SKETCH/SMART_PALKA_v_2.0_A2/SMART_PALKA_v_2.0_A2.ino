...
int max_bright = 155;          // максимальная яркость (0 - 255)
boolean adapt_light = 0;       // адаптивная подсветка (1 - включить, 0 - выключить)

byte fav_modes[] = {45, 46, 47, 48, 49, 50, 51, 53, 54, 55, 56, 22, 25, 21, 7, 24, 29, 38, 52, 1, 10, 2, 3, 34, 42, 5, 8, 11,  27, 13, 26 };  // список "любимых" 
...
void setup()
{
  ...
  Serial.println(F("//=========Rina development assistance Telegram: @RinaTitan==========//"));
  Serial.println(F("//============firmware version 2.0_A2  (16,06,2020)==================//"));
  Serial.println(F(""));
