...
int max_bright = 210;          // максимальная яркость (0 - 255)
boolean adapt_light = 0;       // адаптивная подсветка (1 - включить, 0 - выключить)

byte fav_modes[] = {23, 11, 14, 25, 27, 30, 41, 2};  // список "любимых" режимов
...
///.........настройки..................................................///
double Volt_Max = 3.92; // максимальное значение в вольтах (при подключении по юсби 5.2v)
...
//gnd - 102k -pin5- 51.1k -vcc
// pin d5 ir 

////sis///
////auto_voltage_test///
int Cop_Vol_in; // переменная в которой будем хранить копию значения Vol_in
double ST; //Корректор значений в авто
//volatile uint32_t debounce_2;  //переменная для хранения пройденного времени

bool vol_an = 0;
////auto_voltage_test END///
...
void loop() {
  ...
  switch (ledMode) {
    ...
    case 100: one_color_all(120, 120, 120); LEDS.show(); break; //---ALL White
