...
double Volt_Max = 5.18,              // максимальное значение в вольтах (при подключении по юсби 5.2v) с условием смещение на сегменты
       Volt_Min = 2.6;              // минимальное значение в вольтах (минимальное значение для li-on 2.8v) с условием смещение на сегменты
int     anWrite = 1013;              // analogWrite значение при максимальных вольтах
...
void setup()
{
  ...
  Serial.println(F("//============firmware version 2.0_A1  (16,06,2020)==================//"));
  Serial.println(F(""));
