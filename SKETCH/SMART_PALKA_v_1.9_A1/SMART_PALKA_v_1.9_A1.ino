...
byte fav_modes[] = {45, 22, 7, 24, 29, 52, 1, 10, 2, 26, 13 };  // список "любимых" режимов 38 уменьш скорасть
...
void loop() {
  ...
  if (power_supply == 0 && Anim == 1){Anim = 9; Flag_dD = 1; Cop_Vol_in = 0; Serial.print("Anim = ");Serial.println(Anim);}
  if (power_supply == 1 && Anim != 1){Anim = 1; Flag_dD = 1;                 Serial.print("Anim = ");Serial.println(Anim);}
