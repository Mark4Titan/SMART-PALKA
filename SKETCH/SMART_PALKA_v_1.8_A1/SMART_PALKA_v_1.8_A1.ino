...
void loop() {
  ...
  if (power_supply == 0 && Anim == 1){Anim = 9; Flag_dD = 1; Cop_Vol_in = 0; Serial.println("power_supply == 0");}
  if (power_supply == 1 && Anim != 1){Anim = 1; Flag_dD = 1; Serial.println("power_supply == 1");}
  if (Anim == 0){Anim = 1; Cop_Vol_in = 0;Serial.println("Anim == 0");}
  if (charge_end == 0 && Anim != 12){Anim = 11; Flag_dD = 1; Cop_Vol_in = 0; Serial.println("charge_end == 0");}
  if (charge_end == 1 && Anim > 12){Anim = 1; Cop_Vol_in = 0; Serial.println("charge_end == 1");}
  
  
  if (Anim == 9) {Anim++;Flag_dD = 1; ledMode = 110;Serial.println("Anim == 9");}
  if (Anim == 11){Anim++;Flag_dD = 1; ledMode = 110;Serial.println("Anim == 11");}
