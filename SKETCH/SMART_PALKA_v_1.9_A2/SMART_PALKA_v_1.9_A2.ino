...
byte fav_modes[] = {45, 46, 47, 48, 49, 50, 51, 53, 54, 55, 56, 22, 25, 21, 7, 24, 29, 38, 52, 1, 10, 2, 3, 34, 42, 5, 8, 11, 26, 27, 13 };  // список "любимых" режимов 38 уменьш скорасть
...
void loop() {
 ...
 //авто возврат
  if (millis() - deboD >= 4000 && Anim > 0 && Flag_dD == 1) {
    deboD = millis(); 
